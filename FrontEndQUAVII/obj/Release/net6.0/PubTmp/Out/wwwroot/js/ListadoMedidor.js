...
$("#formRegistro").on("submit", function (e) {
    ...
    // validar si la imagen falla
    const imgError = document.querySelector("#imagenLectura");
    ...
    if (imgot == '') {
        if (nuevaLectura == '' || $('#imagenLectura').val() == '') {
            swal({
                title: "Error",
        ...
        if (nuevaLectura == '') {
            swal({
                title: "Error",
                text: "Completar la lectura, son obligatorios ",
                icon: "error"
            })
            return
        }
